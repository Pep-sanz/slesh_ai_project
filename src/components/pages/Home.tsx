...
export default function Home() {
  return (
    <div className="sm:min-h-screen relative h-full flex flex-col md:justify-center px-6 sm:px-12 py-24 items-center dark:text-foreground text-primary  bg-gradient-to-tr dark:from-background from-foreground dark:from-80% from-85% dark:to-primary/30 to-[#CBEFFF]">
