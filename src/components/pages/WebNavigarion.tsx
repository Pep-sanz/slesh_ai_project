...
export default function WebNavigarion() {
  return (
    <div className="min-h-screen w-full py-24 flex flex-col bg-gradient-to-tl dark:from-background from-foreground from-85% dark:to-primary/20 to-[#CBEFFF] justify-center items-center relative">
        ...
        width={250}
        height={250}
        className="absolute top-7 md:top-3"
        />
      <div className="bg-white/30 p-3 dark:bg-white/10 z-10 pointer-events-none backdrop-blur-md rounded-md">
        <div className="flex flex-col justify-center items-center w-[80vw] h-[300px] md:w-[70vw] md:h-[350px] lg:w-[50vw] lg:h-[60vh] bg-gradient-to-bl dark:from-neutral-950 from-[#F3F3F3] dark:from-50% dark:to-neutral-700 to-[#D2D2D2] rounded-md relative overflow-hidden">
