...
export default function ReletedPages() {
  return (
    <div className="xl:min-h-screen lg:h-[52vh] px-6 py-24 sm:px-12 w-full bg-gradient-to-tr from-background from-85% dark:to-primary/20 to-[#CBEFFF] grid grid-rows-2 md:grid-rows-1 grid-flow-col auto-cols-auto gap-6 md:grid-cols-2">
      <div className="flex justify-center items-center">
        <div className="shadow-bottom-search shadow-primary space-y-3 p-3 text-primary dark:text-foreground">
          <h3 className=" md:text-5xl text-3xl font-extralight flex flex-col">
            Related
            <span className="font-bold ml-3 text-5xl md:text-6xl">Pages</span>
          </h3>
          <p className="font-extralight text-xs text-wrap max-w-[160px] text-neutral-500 dark:text-neutral-200">
            Viewing a content, and get recommended with other pages
          </p>
        </div>
      </div>
      <div className="relative flex justify-center items-center">
        ...
        <div className=" z-20 lg:absolute left-0 flex justify-center items-center lg:w-[469.98px] lg:h-[426.35px] 1051:w-[40vw] w-[80vw] h-[30vh] sm:w-[60vw] sm:h-[40vh] md:h-[50vh] bg-gradient-to-br dark:from-[#1D1D1D] from-[#F3F3F3] dark:to-[#454545] to-[#D2D2D2] rounded-3xl">
